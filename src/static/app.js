document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateAuthControls(username) {
    ...
    loginRequired.classList.toggle("hidden", isAuthenticated);
    signupForm.classList.toggle("hidden", !isAuthenticated);
    teacherName.textContent = isAuthenticated ? `Logged in as ${username}` : "";
  }
  ...
  async function fetchActivities() {
    try {
      ...
      // Add event listeners to unregister buttons for logged-in teachers.
